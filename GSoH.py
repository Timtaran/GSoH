...
if yt == 'No'
    ...
    hc = '' #your text
yn = '64' #your number or text(don't use whitespace please)
hc = yn + hc
hashvalue=hashlib.sha256(hc.encode())
a = '\n\n'+hashvalue.hexdigest()
...
if send_message == 'Yes':
    ...
    try:
        c = vk.messages.search(q='String:', peer_id=ID, count=1)
        c1 = c['items'][0]['conversation_message_id']
